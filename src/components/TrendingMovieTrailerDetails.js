...
import { removeGptSearchMovieListDetails,removegptSearchMovieList } from "../utils/gptSearchSlice";

const TrendingMovieTrailerDetails = () => {
  useGetTrendingMovieDetails();
  useGetTrendingMovieTrailer();
  const dispatch=useDispatch();
  dispatch(removeGptSearchMovieListDetails());
  dispatch(removegptSearchMovieList());
